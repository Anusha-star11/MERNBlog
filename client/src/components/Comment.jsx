  ...
  return (
    <div className="flex p-4 border-b border-gray-600 text sm">
        ...
        <div className="flex-1">
            <div className="flex item-center md-1">
                <span className="mr-1 font-bold text-xs truncate">{user ? `@${user.username}` : 'anonymous user'}</span>
            ...
            {isEditing ? (
                ...
                <div className="flex items-center pt-2 text-xs border-t dark:border-gray-700 max-w-fit gap-2">
                    ...
                    {currentUser && 
                    (currentUser._id === comment.useId || currentUser.isAdmin) && (
                        <>
