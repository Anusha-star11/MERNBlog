...
export default function UpdatePost() {
    ...
    const handleSubmit=async(e)=>{
        ...
        try{
            ...
            setPublishError('Something went room');
        }
    };
  return (
    <div className="p-3 mx-w-3xl mx-auto min-h-screen">
        <h1 className="text-center text-3xl my-7 font-semibold">UpdatePost</h1>
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="flex gap-4 items-center justify-between border-4 border-teal-500 border-dotted p-3">
                ...
                <Button type="button" gradientDuoTone='purpleToBlue' outline size='sm' onClick={handleUploadImage}>
                    {imageUploadProgress ? (
            ...
            <ReactQuill theme="snow" placeholder="write something..." required  className="h-72 mb-12" onChange={(value)=>setFormData({...formData, content : value})} value={formData.content}/>
